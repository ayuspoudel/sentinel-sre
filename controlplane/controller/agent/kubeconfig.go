...
func (c *Controller) loadKubeConfig(ctx context.Context, namespace, secretName string) (kubeconfig []byte, err error) {
...
*/
func (c *Controller) buildRestConfig(kubeconfig []byte, contextName string) (*rest.Config, error) {
	/*
